// This source code is copied from https://github.com/robertodoering/harpy
...
typedef WebviewNavigation = Future<Uri?> Function(
    BuildContext context, TwitterLoginWebview webview);
...
class TwitterAuth {
  ...
  static const callbackUrl = 'writeonlytwitter://';
